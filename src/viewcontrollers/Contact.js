      ...
      <div>
        ...
        <div className="section white">
          <div className="container">
            <h6 className="text-display-1 green-text text-accent-3">Kontakt</h6>
          </div>
          ...
          <div className="row">
            <div className="col s12 l6">
              <div className="white">
                <div>
                  <h6 className="primary-text text-headline">Information</h6>
                  <p className="primary-text text-subhead"><i className="left inline-small-icon material-icons green-text text-accent-3">location_on</i>Lyngby Storcenter 88, 2800 Kongens Lyngby *</p>
                  <p className="primary-text text-subhead"><i className="left inline-small-icon material-icons green-text text-accent-3">phone</i>45 87 66 01</p>
                  <p className="primary-text text-subhead"><i className="left inline-small-icon material-icons green-text text-accent-3">email</i>info@rittercykler.dk</p>
                  <p className="primary-text text-subhead"><i className="left inline-small-icon material-icons green-text text-accent-3">access_time</i>Mandag – Fredag 10:00 – 19:00<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lørdag og Søndag 10:00 – 17:00 </p>
                </div>
                <p className="secondary-text text-body">* Ritter Cykler er beliggende på det 'lille torv' i Lyngbystorcenter. Det lille torv er placeret i den sydøstlige del af centeret ud til Klampenborgvej.<a className="green-text text-accent-3" href={require('../assets/lyngbystorcenter-centeroversigt-februar-2018.png')}> Se kort over lyngbystorcenter</a></p>
              <div>
