      ...
      <div>
        ...
        <div className="section white">
          <div className="container">
            <h6 className="text-display-1 green-text text-accent-3">Reklamation og Returregler</h6>
          </div>
          <div className="container">
          <div className="row">
            <div className="col s12 m10 l6">
              <h6 className="primary-text text-headline">Garanti</h6>
            ...
            <div className="col s12 m10 l6">
              <h6 className="primary-text text-headline">Bytte regler</h6>
              <p className="primary-text text-subhead">
