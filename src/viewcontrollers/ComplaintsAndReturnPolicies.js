      ...
      <div>
        ...
        <div className="section white">
          ...
          <div className="row">
            ...
            <h6 className="primary-text mdc-typography--headline">Garanti</h6>
            <p className="primary-text mdc-typography--subheading1">
            ...
            <h6 className="primary-text mdc-typography--headline">Bytte regler</h6>
            <p className="primary-text mdc-typography--subheading1">
